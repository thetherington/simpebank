...
// Source: github.com/thetherington/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) UpdateAccountInfo(arg0 context.Context, arg1 db.UpdateAccountInfoParams) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpdateAccountInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
